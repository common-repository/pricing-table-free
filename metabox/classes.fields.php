...
abstract class CMB_Field {
	...
	public function display() {
		...
		if ( $this->args['repeatable'] ) {
			...
			<button class="button repeat-field button button-primary"><?php esc_html_e( 'Add Table Features (Unlimited For Pro)', 'cmb' ); ?></button>
...
class CMB_Group_Field extends CMB_Field {
	...
	function __construct() {
		...
		if ( ! empty( $this->args['fields'] ) ) {
			foreach ( $this->args['fields'] as $f ) {
				...
				$class = _cmb_field_class_for_type_ptwnot( $f['type'] );
				$f['show_label'] = true;
	...
	public function display() {
		...
		if ( $this->args['repeatable'] ) {
			...
			$this->value = ''; ?>
				...
				<button class="button repeat-field button button-primary"><?php esc_html_e( 'Add Pricing Column(Unlimited For Pro)', 'cmb' ); ?></button>
	...
	public function html() {
		...
		<?php if ( $this->args['repeatable'] ) : ?>
			<button class="cmb-delete-field button button-primary" title="Remove field"><span class="cmb-delete-field-icon">&times;</span> Remove Column</button>
		<?php endif; ?>
