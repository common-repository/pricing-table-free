...
add_action( 'init', 'cmb_init_ptwnot' );
 ...
 * @return array
 */
function _cmb_available_fields_ptwnot() {
 ...
 */
function _cmb_field_class_for_type_ptwnot( $type ) {

	$map = _cmb_available_fields_ptwnot();
 ...
 * @return string $query
 */
function cmb_fix_meta_query_order_ptwnot($query) {
...
if ( version_compare( get_bloginfo( 'version' ), '3.8', '<' ) )
	add_filter( 'query', 'cmb_fix_meta_query_order_ptwnot', 1 ); 